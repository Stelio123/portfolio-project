export const ProjectData = [
    
    {
        ...
        links:[
        <a href="https://github.com/" target='_blank' alt='github'>GitHub</a>, 
        <a href='https://steliocodes.com/snos-movies/' target='_blank' alt='movie databe wesite' >Live Site</a>],
        mockTitle: 'Mock Up',
        projectImage:[
    ...
    },
    {
        ...
        links: [<a href="https://github.com/" target='_blank' alt='github'>GitHub</a>, 
                <a href="https://steliocodes.com/minesweeper/" target='_blank' alt='github'>Live Site</a>],
    ...
    },
    {
        ...
        tools: 'React, CSS',
        links: <a href="https://steliocodes.com/minesweeper/" target='_blank' alt='live site'>Live Site</a>,
        slug: 'calculator'
    ...
    },
    {
        ...
        tools: 'WordPress, WooCommerce, PHP, SASS, GitHub',
        links: [<a href="https://github.com/" target='_blank' alt='github'>GitHub</a>, 
                <a href="https://steliocodes.com/minesweeper/" target='_blank' alt='github'>Live Site</a>],
        slug: 'massagetherapy'
    },
