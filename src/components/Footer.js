        ...
        <footer>
            <div className='social-icons'>
                <div className='linkedin'>
                  <Link to='/'><svg xmlns="http://www.w3.org/2000/svg" width="31.5" height="31.499" viewBox="0 0 31.5 31.499">
                ...
                <Link to='/'><svg xmlns="http://www.w3.org/2000/svg" width="34.875" height="34.004" viewBox="0 0 34.875 34.004">
